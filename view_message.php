        ...
        <div class="container-fluid main-inbox">
            ...
            <div class="row console">
                <div class="col-md-10 view_message">
                    ...
                    <?php echo "<h2>" . $sent_from->value->f_name . " " . $sent_from->value->l_name . "</h2>\n"; ?>
                    <?php echo "<h3>" . $sent_from->value->city . ", " . $sent_from->value->state . "</h3>\n"; ?>
                    <?php $_SESSION['send_to'] = $sent_from->value->email; ?>
                    <?php echo "<a class='btn btn-primary' href='message.php?msg_id=" . $current_msg->value->msg_subject . "'>Reply</a>\n"; ?>
